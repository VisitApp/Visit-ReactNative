...
export default function App() {
  return (
    <SafeAreaView style={styles.container}>
      <TouchableOpacity
        onPress={() =>
          fetchHourlyFitnessData(1661843593000)
            .then((res) => console.log('fetchHourlyFitnessData res', res))
            .catch((err) => console.log('fetchHourlyFitnessData err,', { err }))
        }
        style={styles.button}
      >
        <Text style={styles.buttonText}>Get Hourly Data</Text>
      </TouchableOpacity>
      <TouchableOpacity
        onPress={() =>
      ...
      >
        <Text style={styles.buttonText}>Get Daily Data</Text>
      </TouchableOpacity>
      <VisitHealthView
