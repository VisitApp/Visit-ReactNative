...
This repository uses [`npm`](https://github.com/npm/cli) for dependency installation, lockfiles, scripts, and CI.
...
To edit the Objective-C or Swift files, open `example/ios/VisitRnSdkExample.xcworkspace` in XCode and find the source files at `Pods > Development Pods > react-native-visit-rn-sdk`.

To edit the Java or Kotlin files, open `example/android` in Android studio and find the source files at `react-native-visit-rn-sdk` under `Android`.
