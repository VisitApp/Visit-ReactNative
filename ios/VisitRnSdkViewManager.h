...
- (void)openAppleHealthApp:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject;
...
- (void)getHealthKitConnectStatus:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject;
