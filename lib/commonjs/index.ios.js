...
const VisitHealthView = _ref => {
  ...
  (0, _react.useEffect)(() => {
    ...
    if (magicLink !== null && magicLink !== void 0 && (_magicLink$trim = magicLink.trim()) !== null && _magicLink$trim !== void 0 && _magicLink$trim.length) {
      ...
      _reactNativeDeviceInfo.default.getUniqueId().then(uniqueId => (0, _Services.getWebViewLink)(magicLinkBaseUrl, token, phone, id, 'iPhone', uniqueId, version, systemVersion, environment)).then(res => {
