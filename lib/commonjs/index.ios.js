...
const VisitHealthView = _ref => {
  ...
  const callSyncApi = (0, _react.useCallback)(data => _axios.default.post(`${baseUrl}/users/data-sync`, data, {
    headers: {
  ...
  const callEmbellishApi = (0, _react.useCallback)(data => _axios.default.post(`${baseUrl}/users/embellish-sync`, data, {
    headers: {
      Authorization: authToken
    }
